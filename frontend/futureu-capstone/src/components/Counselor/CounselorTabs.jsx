  ...
  <div className="flex gap-4 mb-8">
    {tabs.map((tab, idx) => (
      <button
        ...
        className={`px-5 py-2 rounded-full font-semibold text-base transition-colors duration-150 shadow-sm border-2 focus:outline-none focus:ring-2 focus:ring-[#FFB71B] animate-bounce-short ${
          activeTab === idx
