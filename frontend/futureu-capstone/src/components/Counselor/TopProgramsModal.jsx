...
import { BookOpen, X, TrendingUp, TrendingDown, List } from 'lucide-react';

const TopProgramsModal = ({ isOpen, onClose, topPrograms, totalRecommendations }) => {
  ...
  const getFilteredData = () => {
    if (showFilter === 'top') {
      return topPrograms.slice(0, 5);
    } else if (showFilter === 'bottom') {
      return [...topPrograms].reverse().slice(0, 5);
    }
    return topPrograms; // Show all
  };
        ...
        <div className="bg-[#2B3E4E] p-6 text-white">
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              ...
              <div>
                <h3 className="text-left text-xl font-bold">All Top Programs</h3>
        ...
        <div className="p-6 overflow-y-auto max-h-[calc(80vh-180px)]">
          <div className="space-y-2">
            {filteredData.map((p, i) => {
              const percent = totalRecommendations > 0 ? ((p.count / totalRecommendations) * 100).toFixed(1) : '0';
              return (
                <div 
                  key={i} 
...
export default TopProgramsModal;
