...
const CRUD_AssessmentSubCategory = () => {
  ...
  return (
    <div className="container mx-auto px-6 py-8">
      <div className="mb-12">
        <h1 className="text-3xl font-bold text-gray-800 dark:text-gray-100 mb-4">Assessment Sub-Category Management</h1>
            ...
            <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
              {loading && !filteredSubCategories.length ? (
                ...
                paginatedSubCategories.map((subCategory) => (
                  <tr key={subCategory.assessmentSubCategoryId} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                    <td className="px-6 py-4">{subCategory.assessmentSubCategoryId}</td>
                    <td className="px-6 py-4 font-medium text-gray-900 dark:text-gray-100">
                      {subCategory.subCategoryName}
                    </td>
                    <td className="px-6 py-4">
                      {subCategory.assessmentCategory ? (
                        <span className="px-2 py-1 bg-blue-100 text-blue-800 dark:bg-blue-900 dark:text-blue-200 rounded-full text-xs">
                          {subCategory.assessmentCategory.categoryName}
                        </span>
                      ) : (
                        'None'
                      )}
      ...
      <div className="flex justify-between items-center">
        <div className="text-sm text-gray-700 dark:text-gray-300">
          Showing {filteredSubCategories.length > 0 ? page * rowsPerPage + 1 : 0} to {Math.min((page + 1) * rowsPerPage, filteredSubCategories.length)} of {filteredSubCategories.length} sub-categories
        </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-md">
            ...
            <div className="p-6">
              <p className="text-gray-700 dark:text-gray-300">
                Are you sure you want to delete the sub-category "{subCategoryToDelete?.subCategoryName}"? This action cannot be undone.
              </p>
            </div>
            <div className="p-6 border-t border-gray-200 dark:border-gray-700 flex justify-end space-x-3">
              <button
