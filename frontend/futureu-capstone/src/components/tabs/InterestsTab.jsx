      ...
      >
        ...
        <div className="bg-white rounded-xl shadow-md p-5">
          ...
          {displayDescriptions.map((type, index) => (
            <div key={index} className="mb-4 p-4 bg-gradient-to-r from-[#1D63A1]/10 to-[#FFB71B]/10 rounded-lg">
        ...
        <div className="bg-white rounded-xl shadow-md p-5 lg:col-span-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div className="bg-gradient-to-r from-[#1D63A1]/10 to-[#FFB71B]/10 rounded-lg p-4 ">
              <div className="flex justify-between items-center mb-2">
