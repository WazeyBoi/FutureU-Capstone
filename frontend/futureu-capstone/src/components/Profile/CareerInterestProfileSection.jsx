      ...
      >
        ...
        <div className="flex items-center justify-between mb-10 relative z-10">
          ...
          <motion.button
            ...
            className="bg-gradient-to-r from-[#1D63A1] to-[#2B3E4E] hover:from-[#FFB71B] hover:to-[#FF9800] text-white hover:text-[#232D35] px-8 py-4 rounded-2xl font-bold transition-all duration-300 hover:shadow-2xl transform flex items-center shadow-xl border-2 border-white/20"
          >
