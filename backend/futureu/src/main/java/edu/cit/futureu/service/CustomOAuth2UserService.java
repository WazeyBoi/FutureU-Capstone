...
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        try {
            ...
            logger.info("OAuth2 user details: email={}, providerId={}, provider={}", email, providerId, provider);
            ...
            logger.info("CustomOAuth2UserService.loadUser() completed successfully");
            return oAuth2User;
        } catch (Exception e) {
